...
//  * @param {t.TestCase} tc
//  */
// export const testRandomInsert = tc => {
//   const doc1 = new Y.Doc()
//   const doc2 = new Y.Doc()
//   const array1 = doc1.getArray('array')
//   const array2 = doc2.getArray('array')
//   array1.insertRDSL(0, [1, 2, 3])
//   array1.print()
//   array1.insertRDSL(1, [4])
//   array1.print()
// }
...
//     array1.insertRDSL(pos, [i])
//     array2.insert(pos, [i])
//     array1.print()
//     console.log(array2.toArray())
//     t.compare(array1.toArray(), array2.toArray())
//   }
...
//  * @param {t.TestCase} tc
//  */
// export const testRandomBlockInsert = tc => {
//   const doc1 = new Y.Doc()
//   const doc2 = new Y.Doc()
//   const array1 = doc1.getArray('array')
//   const array2 = doc2.getArray('array')
...
//     const arr = new Array(randomLength);
//     totalLength += randomLength;
//     arr.fill(i);
//     array1.insertRDSL(pos, arr)
//     array2.insert(pos, arr)
//     t.compare(array1.toArray(), array2.toArray())
//   }
//   t.compare(array1.toArray(), array2.toArray())
//   console.log(array1.toArray())
 ...
 * @param {t.TestCase} tc
 */
export const testPerformance = tc => {
  const doc1 = new Y.Doc()
  const doc2 = new Y.Doc()
  const array1 = doc1.getArray('array')
  const array2 = doc2.getArray('array')
  ...
  for(let i = 0; i < 1000; i++) {
    ...
    totalLength += randomLength;
    arr.fill(i);
    testData.push({pos, arr});
  }
  let start = performance.now()
  testData.forEach(({pos, arr}) => {
    array1.insertRDSL(pos, arr)
  })
  let end = performance.now()
  console.log(`RDSL: ${end - start}ms`)
  // let start = performance.now()
  // testData.forEach(({pos, arr}) => {
  //   array2.insert(pos, arr)
  // })
  // let end = performance.now()
  // console.log(`Origin: ${end - start}ms`)
}

// /**
//  * @param {t.TestCase} tc
//  */
// export const testFrontInsert = tc => {
//   const doc1 = new Y.Doc()
//   const doc2 = new Y.Doc()
//   const array1 = doc1.getArray('array')
//   const array2 = doc2.getArray('array')
//   for(let i = 0; i < 30; i++) {
//     array1.insertRDSL(0, [i])
//     array2.insert(0, [i])
//   }
//   for(let i = 0; i < 30; i++) {
//     array1.insertRDSL(0, [i, 100+i])
//     array2.insert(0, [i, 100+i])
//   }
//   t.compare(array1.toArray(), array2.toArray())
// }
...
//  * @param {t.TestCase} tc
//  */
// export const testEndInsert = tc => {
//   const doc1 = new Y.Doc()
//   const doc2 = new Y.Doc()
//   const array = doc1.getArray('array')
//   for(let i = 0; i < 30; i++) {
//     array.insertRDSL(i, [i])
//   }
...
//  * @param {t.TestCase} tc
//  */
// export const testEndInsert2 = tc => {
//   const doc1 = new Y.Doc()
//   const doc2 = new Y.Doc()
//   const array = doc1.getArray('array')
//   for(let i = 0; i < 30; i++) {
//     array.insertRDSL(i * 2, [i, 100+i])
//   }
//   console.log(array.toArray())
//   // const update = Y.encodeStateAsUpdate(doc1)
//   // Y.applyUpdate(doc2, update)
